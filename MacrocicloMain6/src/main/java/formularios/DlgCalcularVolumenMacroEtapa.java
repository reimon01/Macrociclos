...
// Este método se llama cuando se desea actualizar los valores en los medios físicos del Macrociclo.
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        // Tu código para registrar el macrociclo
        boolean registroExitoso = persistencia.registrarMacrociclo(macrociclo);

        // Verifica si el registro fue exitoso
        if (registroExitoso) {
            // Muestra un mensaje de éxito utilizando JOptionPane
            JOptionPane.showMessageDialog(null, "El macrociclo se registró correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            // Muestra un mensaje de error si el registro no fue exitoso
            JOptionPane.showMessageDialog(null, "Hubo un problema al registrar el macrociclo", "Error", JOptionPane.ERROR_MESSAGE);
        }        // TODO add your handling code here:
